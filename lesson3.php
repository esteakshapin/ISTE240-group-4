    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>mv document.pdf ~/Documents/<br>(Moves document.pdf to the user’s documents folder. Does not change its name)<br>mv document.pdf resume.pdf<br>(Renames document.pdf to resume.pdf but does not move file)</td>
        </tr>
        <tr>
          <td>cp</td>
          <td>Copies a file</td>
          <td>cp document.pdf ~/Documents/documentcopy.pdf<br>(Copies document.pdf to the user’s documents folder under the name “documentcopy.pdf”</td>
        </tr>
        <tr>
          <td>rm</td>
